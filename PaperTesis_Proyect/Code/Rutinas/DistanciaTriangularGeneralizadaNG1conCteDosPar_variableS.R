...
integrand.DT.NG1<-function(x,s,alfa,ga,L,datos,ancho,Cte) 
...
############################################################################
#### DEFINO LA FUNCION A INTEGRAR CON NUCLEO GAMMA VERSION 1
DT.NG1.Cte.Gen<-function(s,alfa,ga,L,datos,ancho,Cte)
  adaptIntegrate(integrand.DT.NG1,lower = 0, upper = 400,s,alfa,ga,L,datos,ancho,Cte)$integral