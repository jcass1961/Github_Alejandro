...
###### estimador de hill
########################
setwd("C:/Users/debie/Dropbox/KernelEstimation/Code/Rutinas")
getwd()
source("Genera GI en funcion de alfa y gamma.R")
source("distribucionGI.R")

library(nortest)
  
## Genero la muestra aleatoria GI
