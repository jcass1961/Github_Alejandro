...
graf.alfa<-paste("GraficoSesgoMVyGAyLNyLC_L=",L,"Cont_BarrasErrorypercentil.pdf",sep = "")
graf.ECM<-paste("GraficoECMMVyGAyLNyLC_L=",L,"Cont_BarrasErrorypercentil.pdf",sep = "")
