...
muestras.tam.por.tam<-function(imagen,cant.muestras,tam)
{
  ...
  for (i in 1:cant.muestras)
  {
    ...
    muestras[[i]]<-muestra.1
  }
  n<-sum(tams.muestras)
  coord<-data.frame("x1"=x1.tot,"x2"=x2.tot,"y1"=y1.tot,"y2"=y2.tot)
  ...
  #return(list("muestras"=muestras,"salida.lm"=salida.lm,"tams.muestras"=tams.muestras,"muestra"=muestra.1,
  ...
  return(list("muestras"=muestras,"tams.muestras"=tams.muestras,"coordenadas"=coord,
              "medias.cuad"=media.muestras.cuad,"desvios.cuad"=desvio.muestras.cuad
               ))
}
