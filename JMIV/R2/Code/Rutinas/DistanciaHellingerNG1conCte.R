...
integrand.DH.NG1<-function(x,a,L,datos,ancho,Cte) sqrt(GI2(x,a,L)*EstimadorNucleoGama1(x,datos,ancho,Cte))

############################################################################
#### DEFINE EL ESTIMADOR DE DISTANCIA TRIANGULAR CON LOG NORMAL
DH.NG1.Cte<-function(a,L,datos,ancho,Cte) 
1-adaptIntegrate(integrand.DH.NG1,lower = 0, upper = 400,a,L,datos,ancho,Cte)$integral
