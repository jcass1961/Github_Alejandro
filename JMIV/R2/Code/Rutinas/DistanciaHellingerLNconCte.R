...
integrand.DH.LN<-function(x,a,L,datos,ancho,Cte) sqrt(GI2(x,a,L)*EstimadorNucleoLN(x,datos,ancho,Cte))

############################################################################
#### DEFINE EL ESTIMADOR DE DISTANCIA TRIANGULAR CON LOG NORMAL
DH.LN.Cte<-function(a,L,datos,ancho,Cte) 
1-adaptIntegrate(integrand.DH.LN,lower = 0, upper = 400,a,L,datos,ancho,Cte)$integral
