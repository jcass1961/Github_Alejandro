...
graf.alfa<-paste("GraficoSesgoMVyGAyLNyLC_L=",L,"Cont_BarrasErrorypercentil.eps",sep = "")
graf.ECM<-paste("GraficoECMMVyGAyLNyLC_L=",L,"Cont_BarrasErrorypercentil.eps",sep = "")
