...
\begin{document}
	...
	\begin{figure}[hbt]
		\centering
		\subfigure[$L=3$]{\includegraphics[width=.75\linewidth]{DensidadGI0L3.eps}}
		\subfigure[$L=8$]{\includegraphics[width=.75\linewidth]{DensidadGI0L8.eps}}
	...
	\begin{figure*}[hbt]
		\centering
		\subfigure[\label{SesgoSinContL=3}$\widehat{\text{Bias}}$]{\includegraphics[width=0.49\linewidth]{GraficoSesgoMVyGAyLNyLC_L=3SinCont_BarrasErroryPercentil.eps}}
		\subfigure[\label{ECMSinContL=3}$\widehat{\text{MSE}}$]{\includegraphics[width=0.49\linewidth]{GraficoECMMVyGAyLNyLC_L=3SinCont_BarrasErroryPercentil.eps}}
	...
	\begin{figure*}[hbt]
		\centering
		\subfigure[\label{SesgoSinContL=8}$\widehat{\text{Bias}}$]{\includegraphics[width=0.49\linewidth]{GraficoSesgoMVyGAyLNyLC_L=8SinCont_BarrasErroryPercentil.eps}}
		\subfigure[\label{ECMSinContL=8}$\widehat{\text{MSE}}$]{\includegraphics[width=0.49\linewidth]{GraficoECMMVyGAyLNyLC_L=8SinCont_BarrasErroryPercentil.eps}}
	...
	\begin{figure}[hbt]
		\centering
		\subfigure[\label{InflL3alfa-1.5n25}$\widehat{\alpha}=-1.5$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-1punto5L3n25.eps}}%JC Programa: GraficoInvluenciaL3alfa-1punto5n25.R
		\subfigure[\label{InflL3alfa-3n25}$\widehat{\alpha}=-3$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-3L3n25.eps}}%JC Programa:GraficoInvluenciaL3alfa-3n25.R
...
%JC Programa GraficoInvluenciaL3alfa-1punto5n25.R y GraficoInvluenciaL3alfa-3n25.R
	...
	\begin{figure}[hbt]
		\centering
		\subfigure[\label{InflL3alfa-5n25}$\widehat{\alpha}=-5$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-5L3n25.eps}}%JC Programa:GraficoInvluenciaL3alfa-5n25.R
		\subfigure[\label{InflL3alfa-8n25}$\widehat{\alpha}=-8$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-8L3n25.eps}}%JC Programa:GraficoInvluenciaL3alfa-8n25.R
...
%JC Programa GraficoInvluenciaL3alfa-5n25.R y GraficoInvluenciaL3alfa-8n25.R
	...
	\begin{figure}[hbt]
		\centering
		\subfigure[\label{InflL8alfa-1.5n25}$\widehat{\alpha}=-1.5$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-1punto5L8n25.eps}}%JC Programa: GraficoInvluenciaL8alfa-1punto5n25.R
		\subfigure[\label{InflL8alfa-3n25}$\widehat{\alpha}=-3$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-3L8n25.eps}}%JC Programa: GraficoInvluenciaL8alfa-3n25.R
...
%JC Programa GraficoInvluenciaL8alfa-1punto5n25.R y GraficoInvluenciaL3alfa-3n25.R
	...
	\begin{figure}[hbt]
		\centering
		\subfigure[\label{InflL8alfa-5n25}$\widehat{\alpha}=-5$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-5L8n25.eps}}%JC Programa: GraficoInvluenciaL8alfa-5n25.R
		\subfigure[\label{InflL8alfa-8n25}$\widehat{\alpha}=-8$]{\includegraphics[width=.48\linewidth]{CurvaInfluenciaAlfa-8L8n25.eps}}%JC Programa: GraficoInvluenciaL8alfa-8n25.R
...
%JC Programa GraficoInvluenciaL8alfa-5n25.R y GraficoInvluenciaL3alfa-8n25.R
	...
	\begin{figure*}[hbt]
		\centering
		\subfigure[\label{SesgoConContL=3}$\widehat{\text{Bias}}$]{\includegraphics[width=.49\linewidth]{GraficoSesgoMVyGAyLNyLC_L=3Cont_BarrasErrorypercentil.eps}}
		\subfigure[\label{ECMConContL=3}$\widehat{\text{MSE}}$]{\includegraphics[width=.49\linewidth]{GraficoECMMVyGAyLNyLC_L=3Cont_BarrasErrorypercentil.eps}}
	...
	\begin{figure*}[hbt]
		\centering
		\subfigure[\label{SesgoConContL=8}$\widehat{\text{Bias}}$]{\includegraphics[width=.49\linewidth]{GraficoSesgoMVyGAyLNyLC_L=8Cont_BarrasErrorypercentil.eps}}
		\subfigure[\label{ECMConContL=8}$\widehat{\text{MSE}}$]{\includegraphics[width=.49\linewidth]{GraficoECMMVyGAyLNyLC_L=8Cont_BarrasErrorypercentil.eps}}
	...
	\begin{figure}[hbt]
		\centering
		%\subfigure[\label{MuestraLooks}Samples used to estimate ENL]{\includegraphics[width=0.48\linewidth]{MuestrasEstimNumLooks}}
